\begin{table}[h]
    \caption{Complete MAE results on ETT\_h1 across all missing patterns. Mean $\pm$ std over 5 runs. Ranking: \textbf{1st}, \underline{2nd}.}
    ...
    \begin{tabular}{l|ccccc|cc}
        ...
        \textbf{HELIX (Ours)} & \textbf{0.128$\pm$0.005} & \textbf{0.189$\pm$0.012} & \textbf{0.429$\pm$0.011} & \textbf{0.372$\pm$0.015} & \textbf{0.489$\pm$0.014} & 803.5K & 0.06s \\
        ImputeFormer & 0.202$\pm$0.044 & 0.296$\pm$0.036 & 0.492$\pm$0.005 & \underline{0.404$\pm$0.021} & \underline{0.520$\pm$0.017} & 124.0K & 0.08s \\
        SAITS & \underline{0.150$\pm$0.007} & \underline{0.208$\pm$0.009} & \underline{0.440$\pm$0.016} & 0.422$\pm$0.019 & 0.620$\pm$0.016 & 88.2M & 0.05s \\
