...
#SBATCH --job-name=tune_MOMENT_PhysioNet2012_t2
#SBATCH -o /home/bingxing2/home/scx7644/HELIX/Awesome_Imputation/benchmark_code/hyperparameter_tuning_results/MOMENT_PhysioNet2012_tuning/trial_2.out
#SBATCH -e /home/bingxing2/home/scx7644/HELIX/Awesome_Imputation/benchmark_code/hyperparameter_tuning_results/MOMENT_PhysioNet2012_tuning/trial_2.err
#SBATCH --gpus=1
...
# 保存参数配置
cat > /home/bingxing2/home/scx7644/HELIX/Awesome_Imputation/benchmark_code/hyperparameter_tuning_results/MOMENT_PhysioNet2012_tuning/trial_2_params.json <<'EOF'
{
  "n_steps": 48,
  "n_features": 35,
  "epochs": 100,
