...
#SBATCH --job-name=TOTEM_Electricity_point05
#SBATCH -o reproduce_imputation/point05_log/Electricity_log/TOTEM_Electricity.out
#SBATCH -e reproduce_imputation/point05_log/Electricity_log/TOTEM_Electricity.log
module purge
