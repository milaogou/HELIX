\begin{table*}[t]
    \caption{Detailed MAE results on ETT-h1 (48 steps, 7 features) across all missing patterns. Mean $\pm$ std over 5 runs. Ranking: \textbf{1st}, \underline{2nd}.}
    ...
    \begin{tabular}{l|ccccc|cc}
        ...
        \midrule
        HELIX (Ours) & \textbf{0.128$\pm$0.005} & \textbf{0.189$\pm$0.012} & \textbf{0.429$\pm$0.011} & \textbf{0.372$\pm$0.015} & \textbf{0.489$\pm$0.014} & 803.5K & 0.06s \\
