...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 48 --n_features 35 --epochs 1000 --patience 10 --d_block_hidden 64 --n_residual_layers 2 --d_residual_hidden 24 --d_embedding 64 --n_embeddings 128 --commitment_cost 0.250000 --compression_factor 3 --batch_size 16 --lr 0.001958
