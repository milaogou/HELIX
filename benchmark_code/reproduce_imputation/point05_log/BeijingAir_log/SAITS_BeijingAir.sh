...
#SBATCH --job-name=SAITS_BeijingAir_point05
#SBATCH -o reproduce_imputation/point05_log/BeijingAir_log/SAITS_BeijingAir.out
#SBATCH -e reproduce_imputation/point05_log/BeijingAir_log/SAITS_BeijingAir.log
module purge
