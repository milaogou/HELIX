...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 24 --n_features 132 --epochs 1000 --patience 10 --n_layers 2 --d_model 192 --d_ffn 128 --top_k 3 --n_heads 2 --n_kernels 6 --dropout 0.200000 --channel_mixing False --channel_independence True --downsampling_layers 1 --downsampling_window 3 --apply_nonstationary_norm False --batch_size 8 --lr 0.000145
