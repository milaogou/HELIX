...
#SBATCH --job-name=HELIX_PeMS_subseq05
#SBATCH -o reproduce_imputation/subseq05_log/PeMS_log/HELIX_PeMS.out
#SBATCH -e reproduce_imputation/subseq05_log/PeMS_log/HELIX_PeMS.log
module purge
