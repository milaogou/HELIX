...
#SBATCH --job-name=PatchTST_Electricity_subseq05_
#SBATCH -o reproduce_imputation/subseq05_log/Electricity_log/PatchTST_Electricity_.out
#SBATCH -e reproduce_imputation/subseq05_log/Electricity_log/PatchTST_Electricity_.log
module purge
