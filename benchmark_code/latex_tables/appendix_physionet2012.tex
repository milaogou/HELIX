\begin{table}[h]
    \caption{Complete MAE results on PhysioNet2012 across all missing patterns. Mean $\pm$ std over 5 runs. Ranking: \textbf{1st}, \underline{2nd}.}
    ...
    \begin{tabular}{l|c|cc}
        ...
        ImputeFormer & \underline{0.240$\pm$0.009} & 1.4M & 0.89s \\
