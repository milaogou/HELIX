...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 24 --n_features 862 --epochs 1000 --patience 10 --patch_size 4 --patch_stride 8 --downsampling_ratio 4 --ffn_ratio 4 --num_blocks [1,1] --large_size [7,7] --small_size [3,3] --dims [64,128] --small_kernel_merged False --backbone_dropout 0 --head_dropout 0 --use_multi_scale False --individual False --apply_nonstationary_norm False --batch_size 2 --lr 0.000447
