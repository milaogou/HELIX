...
'MOMENT': {
    'n_steps': 48,
    'n_features': 35,
    'patch_size': 24,  # 增大patch
    'patch_stride': 24,
    'transformer_backbone': 't5-small',  # 改用小模型
    'transformer_type': 'encoder_only',
    'n_layers': 2,  # 减少层数
    'd_ffn': 1024,  # 匹配t5-small (512*2)
    'd_model': 512,  # 匹配t5-small
    'dropout': 0.1,
    'head_dropout': 0.1,
    'finetuning_mode': 'linear-probing',  # 只训练head更快
    'revin_affine': True,
