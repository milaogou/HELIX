...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 48 --n_features 35 --epochs 1000 --patience 10 --n_layers 2 --d_model 32 --d_ffn 256 --top_k 3 --n_heads 8 --n_kernels 6 --dropout 0 --channel_mixing False --channel_independence False --downsampling_layers 2 --downsampling_window 3 --apply_nonstationary_norm False --batch_size 32 --lr 0.000162
