...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 24 --n_features 132 --epochs 1000 --patience 10 --n_layers 3 --d_model 64 --d_ffn 256 --top_k 3 --n_heads 2 --n_kernels 6 --dropout 0 --channel_mixing True --channel_independence False --downsampling_layers 1 --downsampling_window 4 --apply_nonstationary_norm False --batch_size 8 --lr 0.001559
