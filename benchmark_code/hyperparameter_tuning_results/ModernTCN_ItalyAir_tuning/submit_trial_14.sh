...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 12 --n_features 13 --epochs 1000 --patience 10 --patch_size 6 --patch_stride 3 --downsampling_ratio 2 --ffn_ratio 2 --num_blocks [1,1] --large_size [5,5] --small_size [3,3] --dims [24,32] --small_kernel_merged False --backbone_dropout 0.100000 --head_dropout 0 --use_multi_scale False --individual False --apply_nonstationary_norm False --batch_size 8 --lr 0.002358
