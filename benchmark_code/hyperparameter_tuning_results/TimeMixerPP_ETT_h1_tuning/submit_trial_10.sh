...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 48 --n_features 7 --epochs 1000 --patience 10 --n_layers 3 --d_model 32 --d_ffn 256 --top_k 3 --n_heads 8 --n_kernels 6 --dropout 0.200000 --channel_mixing True --channel_independence True --batch_size 16 --lr 0.003350
