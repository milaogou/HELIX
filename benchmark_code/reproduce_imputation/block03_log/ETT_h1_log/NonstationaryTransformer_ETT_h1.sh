...
python -u train_model.py --model NonstationaryTransformer --dataset ETT_h1 --dataset_fold_path data/generated_datasets/ett_rate03_step48_block_blocklen6 --saving_path reproduce_imputation/block03_log/ETT_h1_log --device cuda:0 --n_rounds 25 
