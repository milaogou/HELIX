...
python -u train_model_tuning.py \
    ...
    --device cuda:0 \
    --n_rounds 1 \
    --n_steps 12 --n_features 13 --epochs 1000 --patience 10 --d_block_hidden 32 --n_residual_layers 1 --d_residual_hidden 12 --d_embedding 16 --n_embeddings 256 --commitment_cost 0.100000 --compression_factor 4 --batch_size 8 --lr 0.000506
